...
export const UI = {
  ...
  variantDefault: { ja: "バリアントの既定色", en: "Variant default", zh: "变体默认颜色" },
  ...
  imagePosition: { ja: "画像の位置", en: "Image placement", zh: "图片位置" },
  imageTop: { ja: "上部", en: "Top", zh: "顶部" },
  imageLeading: { ja: "先頭", en: "Leading", zh: "左侧" },
  imageTrailing: { ja: "末尾", en: "Trailing", zh: "右侧" },
  cardLayout: { ja: "カードのレイアウト", en: "Card layout", zh: "卡片布局" },
  aspectRatio: { ja: "アスペクト比", en: "Aspect ratio", zh: "宽高比" },
  customSize: { ja: "自由", en: "Custom", zh: "自定义" },
  imageFit: { ja: "画像の表示", en: "Image fit", zh: "图片适配" },
  imageCrop: { ja: "切り抜く", en: "Crop", zh: "裁剪" },
  imageContain: { ja: "全体を表示", en: "Contain", zh: "完整显示" },
  padding: { ja: "内側の余白", en: "Padding", zh: "内边距" },
  spacing: { ja: "要素の間隔", en: "Spacing", zh: "元素间距" },
  contentPosition: { ja: "内容の位置", en: "Content position", zh: "内容位置" },
  textAlignment: { ja: "文字揃え", en: "Text alignment", zh: "文字对齐" },
  bottom: { ja: "下部", en: "Bottom", zh: "底部" },
...
export const KO: Record<UIKey, string> = {
  ...
  screen: "화면", screenName: "화면 이름", name: "이름", background: "배경", variantDefault: "변형 기본 색상", export: "내보내기", project: "프로젝트",
  ...
  options: "옵션", addOption: "옵션 추가", removeOption: "이 옵션 삭제", selectedOption: "초깃값으로 설정(다시 누르면 선택 해제)", image: "이미지", pickImage: "이미지 선택", removeImage: "이미지 제거", imageUrl: "이미지 URL", imageArea: "이미지 영역", imagePosition: "이미지 위치", imageTop: "위쪽", imageLeading: "앞쪽", imageTrailing: "뒤쪽", cardLayout: "카드 레이아웃", aspectRatio: "가로세로 비율", customSize: "사용자 지정", imageFit: "이미지 맞춤", imageCrop: "자르기", imageContain: "전체 표시", padding: "안쪽 여백", spacing: "요소 간격", contentPosition: "콘텐츠 위치", textAlignment: "텍스트 정렬", bottom: "아래쪽", autoWidth: "글자 너비", icon: "아이콘", noIcon: "아이콘 없음", searchIcons: "아이콘 검색",
