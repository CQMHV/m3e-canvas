...
export const KO: Record<UIKey, string> = {
  ...
  options: "옵션", addOption: "옵션 추가", removeOption: "이 옵션 삭제", selectedOption: "초깃값으로 설정(다시 누르면 선택 해제)", image: "이미지", pickImage: "이미지 선택", removeImage: "이미지 제거", imageUrl: "이미지 URL", imageArea: "이미지 영역", imagePosition: "이미지 위치", imageTop: "위쪽", imageLeading: "앞쪽", imageTrailing: "뒤쪽", autoWidth: "글자 너비", icon: "아이콘", noIcon: "아이콘 없음", searchIcons: "아이콘 검색",
